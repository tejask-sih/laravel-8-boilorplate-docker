...
class PremisesTypeRepository extends BaseRepository
{
	use CommonTrait;
	/**
	* @var states
	...
	*/
	public function __construct(PremisesType $premisesType)
	{
	...
	*/
	...
	{
		// $premisesTypeList = $this->premisesType->where('status',1)->get();
		// return $premisesTypeList;
		$model = $this->premisesType;
		$data = $model;
	...
	*/
	public function create($attributes)
	{
		...
		return $this->premisesType->create($attributes);
    }
    
	/**
	* listing premisesType
	*/
	public function all()
	{
	    return $this->premisesType->all();
    }
	...
	*/
	...
	{
	    return $this->premisesType->find($id);
    }
	...
	*/
	...
	{
		$attributes['updated_at'] = date("Y-m-d H:i:s");	
		return $this->premisesType->find($id)->update($attributes);		
	}
	...
	*/
	...
	{
		return $this->premisesType->find($id)->delete();
	}
	/**
	* LOV action type 
	*/
	...
	{
        return $this->premisesType->orderBy('id','desc')->get($fields);        
	}
}